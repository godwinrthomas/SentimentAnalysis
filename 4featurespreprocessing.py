...
['Nice article on unreduced gametes,', '“Environmental stress
 often triggers unreduced gamete production, suggesting that 
 unreduced gametes may facilitate polyploid speciation in response to changing
 environments.“', '“Although unreduced gamete formation may be a meiotic mishap, 
 we suggest that unreduced gametes can be more explicitly considered as a mechanism
 for evolutionary speciation.”', '“Unreduced gametes are also frequently involved in
 interspecific hybridisation events as well as being produced by interspecific hybrids,
 facilitating allopolyploidisation.', '“Heritable genetic variation for unreduced gamete
 production has been observed,
 thereby providing an evolutionary substrate.“']
